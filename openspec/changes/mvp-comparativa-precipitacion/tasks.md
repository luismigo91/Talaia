...
- [x] Prueba de humo: *Deploy* en Dokploy (servicio Compose `infra/docker-compose.yml`, opción "Create .env file") — funcionando el 25‑08‑2026.
- [ ] Añadir `AEMET_API_KEY` real en Dokploy y comprobar `aemet:*` en `/api/v1/status`.
