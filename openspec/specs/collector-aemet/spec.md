...
> Comportamiento **vigente**. Origen: `mvp-comparativa-precipitacion` (MVP: comparativa de precipitación prevista), archivado el 25‑08‑2026 y 05‑09‑2026 (observación/SSE).
...
- Las fixtures de AEMET son un fixture público (municipio `28065`) y un CAP construido según el Anexo 3 oficial: **faltan capturas reales** de `46007`, `46054`, `46235`, `46051` y del tar CAP del área `77`. Requiere una `AEMET_API_KEY` real.
- Falta poner esa clave en Dokploy y comprobar que las fuentes `aemet:*` aparecen sanas en `GET /api/v1/status`.
